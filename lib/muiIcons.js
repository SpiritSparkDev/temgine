...
const iconConfig = [
  ...
  { mui: 'HowToReg', aliases: ['UserCheck'] },
...
// Explicit Columns export to ensure it's available in production
export const Columns = exportedIcons.Columns || exportedIcons.ViewColumnIcon;
