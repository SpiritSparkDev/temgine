...
export const CircularProgressIcon = createIconWrapper(MuiIcons.CircularProgress);
...
export const Compass = CompassCalibrationIcon;
...
export const Indent = FormatIndentIncrease;

export const FormatIndentDecrease = createIconWrapper(MuiIcons.FormatIndentDecrease);
export const Outdent = FormatIndentDecrease;
